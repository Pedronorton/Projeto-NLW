...
const Detail = () => {
    ...
    const routeParams = route.params as Params; // falo pro ts que o routeParams vai ter o formato da interface Params
        ...
        <SafeAreaView style={{flex:1}}>
            ...
            <View style={styles.footer}>
                ...
                <RectButton style={styles.button} onPress={handleComposeMail}>
                    <FontAwesome name="envelope" size={20} color="#fff"></FontAwesome>
